...
int main( int argc, char** argv)
{
	...
	normalize(planesTmp[0], img2, 0, 1, NORM_MINMAX); // 规范化图像

	namedWindow("Convulution Image",WINDOW_AUTOSIZE);
	...
	normalize(planesInvFilt[0], img2, 0, 1, NORM_MINMAX); // 规范化图像

	namedWindow("Inverse Filter Image Restoration",WINDOW_AUTOSIZE);
